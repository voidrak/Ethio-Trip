...
<template>
  <div
    ...
    <div class="mb-24 space-y-6">
      <RouterLink :to="{ name: 'ProviderHome' }" class="flex items-center gap-x-3 text-white">
      ...
      <RouterLink :to="{ name: 'ProviderPackages' }" class="flex items-center gap-x-3 text-white">
