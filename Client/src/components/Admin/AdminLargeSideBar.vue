...
<template>
  <div
    ...
    <div class="mb-24 space-y-6">
      ...
      <RouterLink :to="{ name: 'AdminPackages' }" class="flex items-center gap-x-3 text-white">
      ...
      <RouterLink :to="{ name: 'CreatePackage' }" class="flex items-center gap-x-3 text-white">
        ...
        <h1 class="cursor-pointer text-xl">Add Packages</h1>
      </RouterLink>

      <RouterLink :to="{ name: 'AdminDestination' }" class="flex items-center gap-x-3 text-white">
        <svg class="size-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <path
        ...
        <h1 class="cursor-pointer text-xl">Destinations</h1>
      </RouterLink>
      <RouterLink :to="{ name: 'CreateDestination' }" class="flex items-center gap-x-3 text-white">
        <svg class="size-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <path
            d="M64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l320 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32zM200 344l0-64-64 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l64 0 0-64c0-13.3 10.7-24 24-24s24 10.7 24 24l0 64 64 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-64 0 0 64c0 13.3-10.7 24-24 24s-24-10.7-24-24z" />
        </svg>
        <h1 class="cursor-pointer text-xl">Add Destination</h1>
      </RouterLink>
      <RouterLink :to="{ name: 'AdminUsers' }" class="flex items-center gap-x-3 text-white">
        <svg class="size-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <path
      ...
      <RouterLink :to="{ name: 'AdminPreProvider' }" class="flex items-center gap-x-3 text-white">
        <svg class="size-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
          <path
            d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z" />
        </svg>
        <h1 class="cursor-pointer text-xl">Provider Request</h1>
      </RouterLink>
    </div>
